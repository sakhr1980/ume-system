...
?>
<form class="form-horizontal" role="form" method="post" action="<?php echo site_url(); ?>classes/classes/edit/<?php echo $data['cla_id']; echo '/'.$this->uri->segment(5); // segment(5) for pagination ?>">
    <div class="toolbar col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2">
        <div class="left">
            ...
            <button type="submit" class="btn btn-sm btn-warning"><i class="glyphicon glyphicon-ok-circle"></i> កែប្រែ</button>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="class_name" placeholder="Classname" name="cla_name" value="<?php echo set_value('cla_name',$data['cla_name']); ?>"  pattern=".{3,50}"  title="Allow enter from 3 to 50 characters">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="number" class="form-control" id="use_email" placeholder="cla_capacity" name="cla_capacity" value="<?php echo set_value('cla_capacity',$data['cla_capacity']); ?>" >

		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				<div class="form-group">
					...
					<div class="col-sm-10">
						<input type="text" class="form-control" id="sta_name" placeholder="Name" name="sta_name" value="<?php echo set_value('sta_name', $data['sta_name']); ?>"  pattern=".{2,50}" required title="Allow enter from 2 to 50 characters">
						<?php echo form_error('sta_name'); ?>
					</div>
				</div>
				<div class="form-group">

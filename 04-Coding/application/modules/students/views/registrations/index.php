<div class="toolbar col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2">
    <div class="left">
        ...
        <a href="<?php echo site_url(); ?>students/permissions" class="btn btn-sm btn-default"><i class="glyphicon glyphicon-lock"></i> Permission</a>
    </div>
    <div class="right">
    ...
    <div class="filter">
        <form class="form-inline" role="form" method="post" action="<?php echo base_url(); ?>students/registrations/index">
            <div class="form-group">
                <label class="sr-only" for="stu_name">Group Name</label>
                <input type="text" class="form-control input-sm" id="stu_name" name="stu_name" value="<?php echo set_value('stu_name'); ?>" placeholder="Enter Group Name">
            </div>
            <div class="form-group">
...
<!--                            <td><?php echo date('M d, Y', strtotime($row['stu_created'])); ?></td>
                            <td><?php echo date('M d, Y', strtotime($row['stu_modified'])); ?></td>-->

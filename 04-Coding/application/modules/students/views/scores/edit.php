				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group">
							<label for="rom_building" class="col-sm-3 control-label">Attendance</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="stu_sco_homework" class="col-sm-3 control-label">Homework/Quiz</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="stu_sco_midterm_exam" class="col-sm-3 control-label">Midterm/Assignment</label>
							<div class="col-sm-9">
						...
						<div class="form-group">
							<label for="stu_sco_final_exam" class="col-sm-3 control-label">Final Exam</label>
							<div class="col-sm-9">

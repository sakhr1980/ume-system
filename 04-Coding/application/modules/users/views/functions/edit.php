...
$data = $data[0];
?>
<form class="form-horizontal" role="form" method="post" action="<?php echo site_url(); ?>users/functions/edit/<?php echo $this->uri->segment(4); ?><?php echo '/'.$this->uri->segment(5); ?>">
    <div class="toolbar col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2">
        <div class="left">
            <!--For icon: http://getbootstrap.com/components/-->
            <a href="<?php echo site_url(); ?>users/functions/index/<?php echo $this->uri->segment(5); ?>" class="btn btn-sm btn-<?php echo DEFAULTS; ?>"><i class="glyphicon glyphicon-arrow-left"></i> Back</a>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="tas_functionname" placeholder="Enter function name" name="tas_functionname" value="<?php echo set_value('tas_functionname',$data['tas_functionname']); ?>"  pattern=".{2,50}" required title="Allow enter from 2 to 50 characters">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo form_dropdown('tas_moduleid',array(''=>'--Select--')+$modules,set_value('tas_moduleid', $data['con_moduleid']),"class='form-control'"); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <?php echo form_dropdown('tas_controllerid',array(''=>'--Select--')+$controllers,set_value('tas_controllerid', $data['tas_controllerid']),"class='form-control'"); ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="checkbox">
                            <label><input type="checkbox" name="tas_status" id="tas_status" value="1" <?php echo set_checkbox('tas_status', 1, ($data['con_status']==1)?TRUE:FALSE); ?>> Check to enable this task</label>
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <textarea class="form-control" rows="5" name="tas_description" id="tas_description"><?php echo set_value('tas_description', $data['tas_description']); ?></textarea>
                    </div>
                </div>
...
<script type="text/javascript">
    $(function(){
        $('[name="tas_moduleid"]').change(function(){
            ...
            con_id.html('<option>Loading...</option>');
            $.ajax({

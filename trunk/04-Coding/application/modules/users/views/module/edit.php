...
<form class="form-horizontal" role="form" method="post" action="<?php echo site_url(); ?>users/module/edit/<?php echo $data['mod_id']; echo '/'.$this->uri->segment(5); ?>">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="mod_name" placeholder="Module Name" name="mod_name" value="<?php echo set_value('mod_name',$data['mod_name']); ?>"  pattern=".{2,50}" required title="Allow enter from 2 to 50 characters">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="mod_foldername" placeholder="Enter folder name of module" name="mod_foldername" value="<?php echo set_value('mod_foldername',$data['mod_foldername']); ?>"  pattern=".{2,50}" required title="Allow enter from 2 to 50 characters">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <div class="checkbox">
                            <label><input type="checkbox" name="mod_status" id="mod_status" value="1" <?php echo set_checkbox('mod_status', 1, ($data['mod_status']==1)?TRUE:FALSE); ?>> Check to enable this group</label>
                        </div>
                    </div>
                </div>
                <div class="form-group">

				...
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="pos_title_en" placeholder="Title in latin" name="pos_title_en" value="<?php echo set_value('pos_title_en', $data['pos_title_en']); ?>"  pattern=".{2,50}" required title="Allow enter from 2 to 50 characters">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" id="pos_title_kh" placeholder="Title in khmer" name="pos_title_kh" value="<?php echo set_value('pos_title_kh', $data['pos_title_kh']); ?>"  pattern=".{2,50}" title="Allow enter from 2 to 50 characters">
						...
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="pos_description" id="pos_description" value="<?php echo set_value('pos_description', $data['pos_description']); ?>" pattern=".{1,250}" title="Allow enter from 1 to 250 characters" />
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-sm-10">
								<div class="checkbox">
									<label><input type="checkbox" name="pos_status" id="pos_status" value="1" <?php echo set_checkbox('pos_status', 1, ($data['pos_status'] == 1) ? TRUE : FALSE); ?>> Check to enable this staff position</label>
								</div>
							</div>
						</div>
					</div>

...
//        $this->data['data'] = $this->m_classes->findAllAccounts(PAGINGATION_PERPAGE, $this->uri->segment(4));
        $this->data['groups'] = $this->m_global->getDataArray(TABLE_PREFIX . 'groups', 'gro_id', 'gro_name', 'gro_status');
   
        pagination_config(base_url() . 'classes/index', $this->m_classes->countAllAccounts(), PAGINGATION_PERPAGE);

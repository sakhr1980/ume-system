...
# Dumping data for table ume_school_db.tbl_classes: ~2 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tbl_generation` (
  ...
  `gen_start_year` datetime DEFAULT NULL,
  `gen_created` datetime DEFAULT NULL,
  `gen_modifyd` datetime DEFAULT NULL,
  `gen_status` bit(1) NOT NULL DEFAULT b'1',
  `gen_end_year` datetime DEFAULT NULL,
  PRIMARY KEY (`gen_id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=latin1;

# Dumping data for table ume_school_db.tbl_generation: ~1 rows (approximately)
...
INSERT INTO `tbl_generation` (`gen_id`, `gen_title`, `gen_start_year`, `gen_created`, `gen_modifyd`, `gen_status`, `gen_end_year`) VALUES
	(1, '2014-2015', '2014-09-02 22:14:32', '2014-09-02 22:14:35', '2014-09-02 22:14:37', '', '2014-09-02 22:14:42');
...
INSERT INTO `tbl_schadule` (`sch_id`, `sch_title`, `sch_created`, `sch_modified`, `tbl_majors_maj_id`, `tbl_shift_shi_id`, `sch_academic_year`, `sch_semester`, `sch_year_number`) VALUES
	...
	(14, 'hhh', '2014-09-02 08:55:17', '2014-09-02 08:55:18', 3, 3, '2014-2015', 1, 2);

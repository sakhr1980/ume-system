...
# Dumping data for table ume_school_db.tbl_groups: 0 rows
...
# Dumping data for table ume_school_db.tbl_students: 2 rows
...
# Dumping data for table ume_school_db.tbl_subject: ~1 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_subject_type: ~2 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_users: 0 rows
...
# Dumping data for table ume_school_db.tbl_user_group: 0 rows

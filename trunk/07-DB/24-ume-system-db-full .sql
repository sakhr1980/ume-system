...
# Dumping structure for table ume_school_db.tbl_attendants
DROP TABLE IF EXISTS `tbl_attendants`;
...
# Dumping data for table ume_school_db.tbl_attendants: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_attendants` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_attendants` ENABLE KEYS */;


# Dumping structure for table ume_school_db.tbl_attendant_detail
DROP TABLE IF EXISTS `tbl_attendant_detail`;
...
# Dumping data for table ume_school_db.tbl_attendant_detail: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_attendant_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_attendant_detail` ENABLE KEYS */;


# Dumping structure for table ume_school_db.tbl_book
...
# Dumping data for table ume_school_db.tbl_book: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_book` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_book` ENABLE KEYS */;


# Dumping structure for table ume_school_db.tbl_book_detail
DROP TABLE IF EXISTS `tbl_book_detail`;
CREATE TABLE IF NOT EXISTS `tbl_book_detail` (
  ...
  PRIMARY KEY (`bod_id`),
  CONSTRAINT `fk_tbl_book_detail_tbl_book1` FOREIGN KEY (`bod_id`) REFERENCES `tbl_book` (`boo_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

# Dumping data for table ume_school_db.tbl_book_detail: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_book_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_book_detail` ENABLE KEYS */;
...
# Dumping data for table ume_school_db.tbl_controllers: ~8 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_experiences: ~88 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_groups: ~5 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_group_task: ~27 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_modules: ~2 rows (approximately)
...
# Dumping structure for table ume_school_db.tbl_salling
DROP TABLE IF EXISTS `tbl_salling`;
CREATE TABLE IF NOT EXISTS `tbl_salling` (
  ...
  CONSTRAINT `fk_tbl_salling_tbl_book1` FOREIGN KEY (`sal_boo_id`) REFERENCES `tbl_book` (`boo_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

# Dumping data for table ume_school_db.tbl_salling: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_salling` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_salling` ENABLE KEYS */;
...
# Dumping data for table ume_school_db.tbl_students: 1 rows
...
INSERT INTO `tbl_students` (`stu_id`, `stu_en_firstname`, `stu_number`, `stu_en_lastname`, `stu_kh_firstname`, `stu_kh_lastname`, `stu_card_id`, `stu_counter_number`, `stu_dob`, `stu_current_address`, `stu_pob`, `stu_gender`, `stu_nationality`, `stu_marital_status`, `stu_tel`, `stu_email`, `stu_fax`, `stu_father_name`, `stu_father_occupation`, `stu_mother_name`, `stu_mother_occupation`, `stu_father_tel`, `stu_mother_tel`, `stu_father_email`, `stu_mother_email`, `stu_father_fax`, `stu_mother_faxl`, `stu_father_current_address`, `stu_highschool_name`, `stu_highschool_year`, `stu_highschool_degree`, `stu_highschool_bacii_province`, `stu_highschool_bacii_office`, `stu_highschool_bacii_room`, `stu_highschool_bacii_table`, `stu_highschool_bacii_date`, `stu_study_type`, `stu_spt_id`, `stu_descount`, `stu_job`, `stu_degree`, `stu_score_status`) VALUES
	(1, 'fsdf', NULL, 'fsf', '', 'fasdf', 'M-HR-1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', '');
...
# Dumping data for table ume_school_db.tbl_student_class: ~1 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_student_payments: ~4 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_student_payment_fee: ~36 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_tasks: ~24 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_teacher_record: ~7 rows (approximately)
...
INSERT INTO `tbl_users` (`use_id`, `use_name`, `use_pass`, `use_status`, `use_created`, `use_modified`, `use_email`) VALUES
	(8, 'admin', '04784d8d20a3b0d6f261ec781b9b2626a1398f26', '', '2014-09-06 19:05:32', '2014-10-31 23:41:12', 'sochy.choeun@gmail.com'),
...
# Dumping data for table ume_school_db.tbl_user_group: 11 rows

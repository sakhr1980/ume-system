...
-- Dumping data for table ume_school_db.tbl_teacher: ~2 rows (approximately)
...
-- Dumping data for table ume_school_db.tbl_teacher_record: ~5 rows (approximately)
...
INSERT INTO `tbl_teacher_record` (`rec_id`, `tbl_teacher_tea_id`, `rec_date`, `rec_time`, `rec_desc`, `rec_other`, `rec_student`, `rec_absent`) VALUES
	(6, 2, '2014-09-22', '', '', '', 0, 0),
	(7, 2, '2014-09-27', '', '', '', 0, 0),
	(8, 1, '2014-09-22', '1', '1', '1', 1, 1),
	(9, 1, '2014-09-23', '2', '2', '2', 2, 2),
	(10, 1, '2014-09-23', '3', '3', '3', 3, 3);

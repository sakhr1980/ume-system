...
# Dumping data for table ume_school_db.tbl_classes: ~6 rows (approximately)
/*!40000 ALTER TABLE `tbl_classes` DISABLE KEYS */;
INSERT INTO `tbl_classes` (`cla_id`, `cla_name`, `cla_capacity`, `cla_status`, `tbl_shift_shi_id`, `cla_maj_id`, `tbl_generation_gen_id`, `cla_create_date`, `cla_modified_date`, `cla_academic_year`) VALUES
	(1, 'MM1', 25, 0, 1, 4, 1, '2014-09-02', '2014-09-06', NULL),
	(2, 'HM44', 30, 0, 1, 3, 1, '2014-09-03', '2014-09-06', NULL),
	(3, 'E04', 25, 0, 4, 3, 1, '2014-09-05', '2014-09-06', NULL),
	(4, 'M01', 25, 1, 1, 3, 2, '2014-09-06', NULL, NULL),
	(5, 'M02', 30, 1, 1, 15, 2, '2014-09-06', NULL, NULL),
	(6, 'W01', 25, 1, 4, 15, 1, '2014-09-06', NULL, NULL);
...
# Dumping data for table ume_school_db.tbl_experiences: ~42 rows (approximately)
...
INSERT INTO `tbl_generation` (`gen_id`, `gen_title`, `gen_start_year`, `gen_created`, `gen_modifyd`, `gen_status`, `gen_end_year`) VALUES
	(1, '2014-2015', '2014', '2014-09-02 22:14:35', '2014-09-02 22:14:37', '', '2014'),
...
INSERT INTO `tbl_students` (`stu_id`, `stu_en_firstname`, `stu_card_id`, `stu_en_lastname`, `stu_dob`, `stu_current_address`, `stu_kh_firstname`, `stu_kh_lastname`, `stu_pob`, `stu_gender`, `stu_nationality`, `stu_marital_status`, `stu_tel`, `stu_email`, `stu_fax`, `stu_father_name`, `stu_father_occupation`, `stu_mother_name`, `stu_mother_occupation`, `stu_father_tel`, `stu_mother_tel`, `stu_father_email`, `stu_mother_email`, `stu_father_fax`, `stu_mother_faxl`, `stu_father_current_address`, `stu_highschool_name`, `stu_highschool_year`, `stu_highschool_degree`, `stu_highschool_bacii_province`, `stu_highschool_bacii_office`, `stu_highschool_bacii_room`, `stu_highschool_bacii_table`, `stu_highschool_bacii_date`, `stu_job`, `stu_score_status`) VALUES
	...
	(34, 'kjlj', NULL, 'ljlj', '2014-09-03', '', 'lkj', 'lj', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', 'មានការងារធ្វើ', ''),
	(35, 'ljlkj', '3', 'jljlk', '0000-00-00', '', 'jlkj', 'ljlk', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', 'មានការងារធ្វើ', ''),
	(36, 'ou', '3', 'sophea', '0000-00-00', '', 'ou', 'ou', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', 'មានការងារធ្វើ', ''),
	(37, 'hfghg', '4', 'hfghf', '0000-00-00', '', 'hfghf', 'dasdasd', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', 'មានការងារធ្វើ', '');
...
# Dumping data for table ume_school_db.tbl_student_class: ~4 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_user_group: 4 rows

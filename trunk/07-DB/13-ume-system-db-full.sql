...
# Dumping data for table ume_school_db.tbl_classes: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tbl_generation` (
  ...
  `gen_status` binary(1) NOT NULL DEFAULT '\0',
...
INSERT INTO `tbl_generation` (`gen_id`, `gen_title`, `gen_start_year`, `gen_created`, `gen_modifyd`, `gen_status`, `gen_end_year`) VALUES
	(1, '2014-2015', '2014-09-02 22:14:32', '2014-09-02 22:14:35', '2014-09-02 22:14:37', _binary 0x00, '2014-09-02 22:14:42'),
	(2, '2015-2016', '2015-09-02 22:16:42', '2014-09-02 22:16:49', NULL, _binary 0x00, '2016-09-02 22:16:53');
...
# Dumping data for table ume_school_db.tbl_staff: ~4 rows (approximately)

...
# Dumping data for table ume_school_db.tbl_classes: ~9 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_controllers: ~7 rows (approximately)
...
# Dumping structure for table ume_school_db.tbl_degree
...
# Dumping data for table ume_school_db.tbl_degree: ~4 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_experiences: ~86 rows (approximately)
...
INSERT INTO `tbl_generation` (`gen_id`, `gen_title`, `gen_start_year`, `gen_spay`, `gen_epay`, `gen_end_year`, `gen_created`, `gen_modifyd`, `gen_status`) VALUES
	(1, '2012-2013', '2012', NULL, NULL, '2013', '2014-09-02 22:14:35', '2014-09-02 22:14:37', ''),
	(2, '2013-2014', '2013', NULL, NULL, '2014', '2014-09-05 08:50:33', NULL, ''),
	(3, '2014-2015', '2014', '2014-11-08', '2014-10-28', '2015', NULL, NULL, ''),
	(4, '2015-2016', '2015', '2015-10-20', '2015-10-28', '2016', NULL, NULL, ''),
	(5, '2016-2017', '2016', '2016-10-28', '2016-10-28', '2017', NULL, NULL, ''),
	(6, '2017-2018', '2017', '2014-10-28', '2014-10-28', '2018', NULL, NULL, ''),
	(7, '2017-2018', '2017', '2014-10-20', '2014-10-28', '2018', NULL, NULL, '');
...
CREATE TABLE IF NOT EXISTS `tbl_group_task` (
  ...
  CONSTRAINT `fk_tbl_group_task_tbl_groups1` FOREIGN KEY (`grotas_groupid`) REFERENCES `tbl_groups` (`gro_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_group_task_tbl_tasks1` FOREIGN KEY (`grotas_taskid`) REFERENCES `tbl_tasks` (`tas_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
...
# Dumping structure for table ume_school_db.tbl_major_fee
DROP TABLE IF EXISTS `tbl_major_fee`;
CREATE TABLE IF NOT EXISTS `tbl_major_fee` (
  ...
  CONSTRAINT `fk_tbl_major_fee_tbl_generation1` FOREIGN KEY (`maf_academic_year`) REFERENCES `tbl_generation` (`gen_id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_major_fee_tbl_majors1` FOREIGN KEY (`maf_maj_id`) REFERENCES `tbl_majors` (`maj_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=latin1;

# Dumping data for table ume_school_db.tbl_major_fee: ~5 rows (approximately)
/*!40000 ALTER TABLE `tbl_major_fee` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `tbl_major_fee` ENABLE KEYS */;
...
# Dumping data for table ume_school_db.tbl_modules: ~3 rows (approximately)
...
INSERT INTO `tbl_modules` (`mod_id`, `mod_name`, `mod_foldername`, `mod_status`, `mod_created`, `mod_modified`, `mod_description`) VALUES
	...
	(2, 'Student Payment', 'payment', 1, '2014-10-25 22:07:34', NULL, ''),
	(3, 'Registrations', 'Students', 1, '2014-10-26 14:06:19', NULL, '');
/*!40000 ALTER TABLE `tbl_modules` ENABLE KEYS */;


# Dumping structure for table ume_school_db.tbl_payment_of_academic_year
DROP TABLE IF EXISTS `tbl_payment_of_academic_year`;
CREATE TABLE IF NOT EXISTS `tbl_payment_of_academic_year` (
  ...
  PRIMARY KEY (`apa_id`),
  CONSTRAINT `fk_tbl_payment_of_academic_year_tbl_generation1` FOREIGN KEY (`apa_id`) REFERENCES `tbl_generation` (`gen_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

# Dumping data for table ume_school_db.tbl_payment_of_academic_year: ~0 rows (approximately)
/*!40000 ALTER TABLE `tbl_payment_of_academic_year` DISABLE KEYS */;
/*!40000 ALTER TABLE `tbl_payment_of_academic_year` ENABLE KEYS */;
...
INSERT INTO `tbl_room_type` (`rom_typ_id`, `rom_typ_name`, `rom_typ_description`, `rom_typ_status`, `rom_typ_created`, `rom_typ_modified`, `rom_typ_use_id`) VALUES
	(4, 'Lab Computer', 'For student IT practice', '', '2014-08-16', NULL, NULL),
	(5, 'Normal Room', '', '', '2014-08-16', NULL, NULL),
	(6, 'Big Room', '', '', '2014-08-16', NULL, NULL),
	(7, 'Big Room 1', 'For student IT practice', '', '2014-08-31', NULL, NULL);
...
INSERT INTO `tbl_staff` (`sta_id`, `sta_card_id`, `sta_name`, `sta_name_kh`, `sta_status`, `sta_position`, `sta_job_type`, `sta_start_date`, `sta_email`, `sta_phone`, `sta_sex`, `sta_address`, `sta_created`, `sta_modified`, `tbl_users_use_id`) VALUES
	(2, '03392', 'borin', 'បូរិន', '', '5', 4, '2014-08-28', '', '', 'f', '', '2014-08-26 18:01:26', NULL, 1),
	(3, '43434', '4rrwer', 'erwer', '', 'Teacher', 0, '2014-08-31', 'souophea@gmail.com', NULL, 'm', '', '2014-08-29 15:30:27', '2014-08-31 01:57:03', 1),
	(4, '43439', 'sophea', 'សុភា', '', 'Teacher', 0, '2014-08-31', 'fsd@fsdf.sdf', NULL, 'f', 'Phnom Penh', '2014-08-31 01:50:14', '2014-08-31 01:56:33', 1),
	(5, '53453', '434', 'សុភា', '', '5', 4, '0000-00-00', '', '', 'm', '', '2014-09-01 16:44:27', '2014-09-06 11:26:48', 1),
	(6, '03390', 'borin', 'បូរិន', '', 'Teacher', 0, '2014-09-05', 'boring@gmail.com', NULL, 'm', 'Phnom Penh', '2014-09-05 01:28:38', NULL, 1),
	(7, '03329', 'Chana', 'ចាន់ណា', '', 'Teacher', 0, '2014-09-06', 'chana@gmail.com', NULL, 'm', 'Phnom Penh', '2014-09-06 05:31:18', NULL, 1),
	(8, '43435', 'FASDFA', 'FASDFA', '', '6', 4, '2014-08-31', 'souopheDa@gmail.com', '4344234234', 'f', 'FSDFSDF', '2014-09-06 11:57:37', '2014-09-06 11:57:45', 1),
	(9, '43423', 'LJLKJ', 'JLKJ', '', '5', 4, '2014-09-08', 'souopheFSDa@gmail.com', '8797897979', 'm', '', '2014-09-06 11:58:29', NULL, 1);
...
# Dumping data for table ume_school_db.tbl_students: 68 rows
...
INSERT INTO `tbl_students` (`stu_id`, `stu_en_firstname`, `stu_number`, `stu_en_lastname`, `stu_kh_firstname`, `stu_kh_lastname`, `stu_card_id`, `stu_counter_number`, `stu_dob`, `stu_current_address`, `stu_pob`, `stu_gender`, `stu_nationality`, `stu_marital_status`, `stu_tel`, `stu_email`, `stu_fax`, `stu_father_name`, `stu_father_occupation`, `stu_mother_name`, `stu_mother_occupation`, `stu_father_tel`, `stu_mother_tel`, `stu_father_email`, `stu_mother_email`, `stu_father_fax`, `stu_mother_faxl`, `stu_father_current_address`, `stu_highschool_name`, `stu_highschool_year`, `stu_highschool_degree`, `stu_highschool_bacii_province`, `stu_highschool_bacii_office`, `stu_highschool_bacii_room`, `stu_highschool_bacii_table`, `stu_highschool_bacii_date`, `stu_study_type`, `stu_spt_id`, `stu_descount`, `stu_job`, `stu_degree`, `stu_score_status`) VALUES
	(1, '22', NULL, '22', '22', '22', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 1, NULL, 'មានការងារធ្វើ', '', ''),
	(30, 'dfd', NULL, 'Bora', 'dfd', 'vong', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 1, NULL, 'មានការងារធ្វើ', '', ''),
	(3, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', 'Male', 'Khmer', 'Single', '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 1, NULL, 'ជានិស្សិត', '', ''),
	(4, 'សុជី', NULL, 'Choeun', 'សុជី', 'សុជី', NULL, NULL, '0000-00-00', '', '', 'Male', '', 'Single', '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(31, 'as', NULL, 'as', 'as', 'dasd', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(32, 'as', NULL, 'as', 'as', 'dasd', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(5, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', NULL, 'Khmer', NULL, '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(6, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', NULL, 'Khmer', NULL, '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(7, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', NULL, 'Khmer', NULL, '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(8, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', NULL, 'Khmer', NULL, '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(9, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', 'Male', 'Khmer', 'Single', '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(10, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', 'Male', 'Khmer', 'Single', '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(11, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', 'Male', 'Khmer', 'Single', '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(12, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', 'Others', 'Khmer', 'Married', '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(13, 'Sochy', NULL, 'Choeun', 'សុជី', 'ជឿន', NULL, NULL, '1988-11-08', '', 'OdorMeanChey', 'Male', 'Khmer', 'Single', '097173656373', 'sochy.choeun@gmail.com', '', 'Chham Mouy', 'Farmer', 'Prom Chouen', 'Solier', NULL, '0998766525552', NULL, '', NULL, '', '', 'Name of School/Institution/University', '2009', 'Bac II', 'Banteay MeanChey', 'Khlar Kon', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(14, 'fadf', NULL, 'fadsf', 'fasdf', 'fadf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(15, 'fadf', NULL, 'fadsf', 'fasdf', 'fadf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(16, 'fasdf', NULL, 'fadf', 'fadf', 'fsa', NULL, NULL, '0000-00-00', '', '', 'Female', 'dfad', 'Single', 'fadf', 'fla', '', 'fasdf', 'lj', 'lj', 'ljl', NULL, 'lj', NULL, 'kkljl', NULL, 'jl', 'lkj', 'lkj', 'f', 'lj', 'kjljkl', 'ljkjl', 'ljljl', 'jkjljk', 'jkljk', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(17, 'fsadfadsf', NULL, 'fasdf', 'fadfadf', 'fsdafasdf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(18, 'fadsf', NULL, 'fdf', ' អ៊ូ', 'ពន្លីរស្មីសុភា', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(19, 'fadsf', NULL, 'fadf', 'fadf', 'dfadf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(20, 'fadsf', NULL, 'fadf', 'fadf', 'dfadf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(21, 'fadsf', NULL, 'fadf', 'fadf', 'dfadf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(22, 'fadsf', NULL, 'fadf', 'fadf', 'dfadf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(23, 'fsdafdasd', NULL, 'fsdf', 'fasdf', 'dfasdf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(24, 'ljkljl', NULL, 'ljj', 'ljkjl', 'fsdf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(25, 'fasdfasd', NULL, 'fsdfsdf', 'fadf', 'fsf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(26, 'fasdfasd', NULL, 'fsadfa', 'fadfa', 'fadf', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, '', '', ''),
	(28, 'klj', NULL, 'hhkjh', 'klj', 'klj', NULL, NULL, '0000-00-00', '', '', 'Male', '', 'Married', '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(29, '111', NULL, '111', '111', '111', NULL, NULL, '0000-00-00', '', '', 'Others', '', 'Single', '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(33, 'fasdfasdf', NULL, 'dfads', 'adfasdf', 'dfsd', NULL, NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(44, 'អ៊ូ', NULL, 'aaa', 'អ៊ូ', 'អ៊ូ', '3', NULL, '0000-00-00', '', '', NULL, '', NULL, '2', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(45, 'fsfs', NULL, 'bb', 'hfghf', 'fsfs', 'M-HR-1-004', NULL, '0000-00-00', '', '', 'Male', '', NULL, '2', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(36, 'ou', NULL, 'sophea', 'ou', 'ou', 'M-HR-1-017', NULL, '0000-00-00', '', '', NULL, '', NULL, '2', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 2, NULL, 'មានការងារធ្វើ', '', ''),
	(40, 'fadf', NULL, 'fadf', '', '', '--1-001', NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(42, 'fadf ', NULL, 'fadf', '', '', 'M-TG-1-001', NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(43, 'fadf ', NULL, 'fadf', '', '', '--1-001', NULL, '0000-00-00', '', '', NULL, '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(46, 'ddd', NULL, 'ddd', '', 'ddd', 'W-PM-3-009', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'ជានិស្សិត', '', ''),
	(47, 'dddsss', NULL, 'aa', 'ស្រុន', 'បូរ៉ា', 'M-HR-3-020', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, 3, NULL, 'មានការងារធ្វើ', '', ''),
	(48, 'fsdfsd', NULL, 'fs', '', '', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(49, 'fsdfsd', NULL, 'fs', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(50, 'fsdfsd', NULL, 'fs', '', '', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(51, 'fsdfsd', NULL, 'fs', '', '', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(52, 'fsdf', NULL, 'fsdf', '', '', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(53, 'ssss', NULL, 'ssss', '', '', 'M-MM-1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(55, 'ssss', NULL, 'ssss', '', '', 'M-MM-1-002', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(56, 'ssss', NULL, 'ssss', '', '', 'M-MM-1-003', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(57, 'ff', NULL, 'ff', 'ff', 'f ', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'ជានិស្សិត', '', ''),
	(58, 'a', NULL, 'aa', '', '', 'M-MM-1-004', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(59, ' dfadsf', NULL, 'sadfasd', '', '', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(60, 'sfsd', NULL, 'sdf', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(61, 'fadf', NULL, 'fasdf', '', '', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(62, 'aaa', NULL, 'aaa', 'aaa', '', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(65, 'ffa', NULL, 'fasd', '', 'fasdf', 'A-MM-1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(69, 'fsdf', NULL, 'fad', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(70, 'fsdf', NULL, 'fad', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(71, 'fsdf', NULL, 'fad', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(73, 'fads', NULL, 'fasdf', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(74, 'fads', NULL, 'fasdf', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(75, 'fads', NULL, 'fasdf', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(76, 'fads', NULL, 'fasdf', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(77, 'fads', NULL, 'fasdf', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(78, 'fads', NULL, 'fasdf', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(79, 'fads', NULL, 'fasdf', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(85, 'fsdf', NULL, 'dfa', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(89, 'fsdf', NULL, 'dfa', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(91, ' fsdf', NULL, 'fsfd', '', '', '--1-001', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', ''),
	(96, 'sophea', NULL, 'gsdf', '', '', 'M-HR-1-021', NULL, '0000-00-00', '', '', 'Male', '', NULL, '', '', '', '', '', '', '', NULL, '', NULL, '', NULL, '', '', '', '', '', '', '', '', '', '', NULL, NULL, NULL, 'មានការងារធ្វើ', '', '');
...
CREATE TABLE IF NOT EXISTS `tbl_student_class` (
  ...
  CONSTRAINT `fk_tbl_student_class_tbl_classes1` FOREIGN KEY (`stucla_cla_id`) REFERENCES `tbl_classes` (`cla_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB AUTO_INCREMENT=54 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;

# Dumping data for table ume_school_db.tbl_student_class: ~48 rows (approximately)
...
INSERT INTO `tbl_student_class` (`stucla_id`, `stucla_stu_id`, `stucla_cla_id`, `stucla_year_study`, `stucla_degree`, `stucla_status`, `stucla_description`, `stucla_id_card`) VALUES
	(1, 34, 2, 1, 'BB', '', NULL, NULL),
	(2, 35, 2, 1, 'BB', '', NULL, NULL),
	(3, 36, 2, 1, 'MS', '', NULL, NULL),
	(4, 37, 1, 4, 'BB', '', NULL, NULL),
	(5, 38, 2, 1, 'BB', '', NULL, NULL),
	(6, 39, 2, 1, 'BB', '', NULL, NULL),
	(7, 41, 2, 1, 'BB', '', NULL, NULL),
	(8, 44, 2, 4, 'BB', '', NULL, NULL),
	(9, 45, 2, 4, 'BB', '', NULL, NULL),
	(10, 46, 8, 5, 'MS', '', NULL, NULL),
	(11, 47, 2, 3, 'MS', '', NULL, NULL),
	(17, 54, 1, 1, '1', NULL, NULL, NULL),
	(18, 55, 1, 1, '1', NULL, NULL, NULL),
	(19, 56, 1, 1, '1', NULL, NULL, NULL),
	(20, 57, 2, 1, '1', NULL, NULL, NULL),
	(21, 58, 1, 1, '1', NULL, NULL, NULL),
	(22, 59, 2, 1, '1', NULL, NULL, NULL),
	(23, 61, 2, 1, '1', NULL, NULL, NULL),
	(24, 62, 2, 1, '1', NULL, NULL, NULL),
	(25, 63, 2, 1, '1', NULL, NULL, NULL),
	(26, 64, 2, 1, '1', NULL, NULL, NULL),
	(27, 66, 2, 1, '1', NULL, NULL, NULL),
	(28, 67, 2, 1, '1', NULL, NULL, NULL),
	(29, 68, 2, 1, '1', NULL, NULL, NULL),
	(30, 72, 2, 1, '1', NULL, NULL, NULL),
	(31, 80, 2, 1, '1', NULL, NULL, NULL),
	(32, 81, 2, 1, '1', NULL, NULL, NULL),
	(33, 82, 2, 1, '1', NULL, NULL, NULL),
	(34, 83, 2, 1, '1', NULL, NULL, NULL),
	(35, 84, 2, 1, '1', NULL, NULL, NULL),
	(36, 86, 2, 1, '1', NULL, NULL, NULL),
	(37, 87, 2, 1, '1', NULL, NULL, NULL),
	(38, 88, 2, 1, '1', NULL, NULL, NULL),
	(39, 90, 2, 1, '2', NULL, NULL, NULL),
	(40, 92, 2, 1, '2', NULL, NULL, NULL),
	(41, 93, 2, 1, '2', NULL, NULL, NULL),
	(42, 94, 2, 1, '2', NULL, NULL, NULL),
	(43, 95, 2, 1, '2', NULL, NULL, NULL),
	(44, 96, 2, 3, '1', NULL, NULL, NULL),
	(45, 97, 4, 1, '2', NULL, NULL, NULL),
	(46, 98, 4, 1, '3', NULL, NULL, NULL),
	(47, 99, 4, 1, '1', NULL, NULL, NULL),
	(48, 100, 2, 1, '1', NULL, NULL, NULL),
	(49, 101, 2, 2, '1', NULL, NULL, NULL),
	(50, 102, 4, 1, 'MS', NULL, NULL, NULL),
	(51, 103, 4, 1, '1', NULL, NULL, NULL),
	(52, 104, 2, 1, '1', NULL, NULL, NULL),
	(53, 105, 9, 1, NULL, NULL, NULL, NULL);
...
# Dumping data for table ume_school_db.tbl_student_payments: ~28 rows (approximately)
...
INSERT INTO `tbl_student_payments` (`sp_id`, `tbl_users_id`, `sp_cla_id`, `sp_stu_id`, `sp_year`, `sp_balance`, `sp_fee`, `sp_status`, `sp_comment`) VALUES
	(11, 9, 2, 96, 1, 100, 100, NULL, NULL),
	(12, 9, 2, 96, 2, 150, 150, NULL, NULL),
	(13, 9, 2, 96, 3, 400, 400, NULL, NULL),
	(14, 9, 2, 96, 4, 450, 450, NULL, NULL),
	(15, 9, 2, 100, 1, 315, 315, NULL, NULL),
	(16, 9, 2, 100, 2, 0, 0, NULL, NULL),
	(17, 9, 2, 100, 3, 0, 0, NULL, NULL),
	(18, 9, 2, 100, 4, 0, 0, NULL, NULL),
	(19, 9, 2, 101, 1, 200, 200, NULL, NULL),
	(20, 9, 2, 101, 2, 300, 300, NULL, NULL),
	(21, 9, 2, 101, 3, 400, 400, NULL, NULL),
	(22, 9, 2, 101, 4, 450, 450, NULL, NULL),
	(23, 9, 4, 102, 1, 0, 0, NULL, NULL),
	(24, 9, 4, 102, 2, 0, 0, NULL, NULL),
	(25, 9, 4, 102, 3, 0, 0, NULL, NULL),
	(26, 9, 4, 102, 4, 0, 0, NULL, NULL),
	(27, 8, 4, 103, 1, 0, 0, NULL, NULL),
	(28, 8, 4, 103, 2, 0, 0, NULL, NULL),
	(29, 8, 4, 103, 3, 0, 0, NULL, NULL),
	(30, 8, 4, 103, 4, 0, 0, NULL, NULL),
	(31, 8, 4, 104, 4, 0, 0, NULL, NULL),
	(32, 8, 4, 104, 3, 0, 0, NULL, NULL),
	(33, 8, 4, 104, 2, 0, 0, NULL, NULL),
	(34, 8, 4, 104, 1, 0, 0, NULL, NULL),
	(35, 8, 9, 105, 1, 0, 0, NULL, NULL),
	(36, 8, 9, 105, 1, 0, 0, NULL, NULL),
	(37, 8, 9, 105, 1, 0, 0, NULL, NULL),
	(38, 8, 9, 105, 1, 0, 0, NULL, NULL);
/*!40000 ALTER TABLE `tbl_student_payments` ENABLE KEYS */;


# Dumping structure for table ume_school_db.tbl_student_payment_fee
DROP TABLE IF EXISTS `tbl_student_payment_fee`;
...
# Dumping data for table ume_school_db.tbl_student_payment_fee: ~35 rows (approximately)
/*!40000 ALTER TABLE `tbl_student_payment_fee` DISABLE KEYS */;
INSERT INTO `tbl_student_payment_fee` (`spf_id`, `spf_spt_id`, `spf_discount_period`, `spf_discount_value`, `spf_stu_id`) VALUES
	...
	(34, 1, 0, 0, 104),
	(35, 2, 0, 0, 105);
/*!40000 ALTER TABLE `tbl_student_payment_fee` ENABLE KEYS */;


# Dumping structure for table ume_school_db.tbl_student_payment_type
DROP TABLE IF EXISTS `tbl_student_payment_type`;
...
# Dumping data for table ume_school_db.tbl_student_payment_type: ~3 rows (approximately)
/*!40000 ALTER TABLE `tbl_student_payment_type` DISABLE KEYS */;
INSERT INTO `tbl_student_payment_type` (`spt_id`, `spt_title`, `spt_status`) VALUES
	(1, 'UME Scolarship', '1'),
	(2, 'Partner Scolarship', '1'),
	(3, 'Pay', '1');
/*!40000 ALTER TABLE `tbl_student_payment_type` ENABLE KEYS */;
...
# Dumping data for table ume_school_db.tbl_stu_payment_detail: ~15 rows (approximately)
/*!40000 ALTER TABLE `tbl_stu_payment_detail` DISABLE KEYS */;
INSERT INTO `tbl_stu_payment_detail` (`spd_id`, `spd_sp_id`, `spd_cdate`, `spd_mdate`, `spd_amount`, `spd_comment`, `spd_status`) VALUES
	(1, 18, NULL, NULL, 100, NULL, ''),
	(2, 18, NULL, NULL, 100, NULL, ''),
	(3, 17, NULL, NULL, 100, NULL, ''),
	(4, 18, NULL, NULL, 300, '', ''),
	(5, 18, '2014-10-18', NULL, 300, '', ''),
	(6, 18, '2014-10-18', NULL, 30, '', ''),
	(7, 18, '2014-10-18', NULL, 40, '', ''),
	(8, 18, '2014-10-18', NULL, 3, '', ''),
	(9, 18, '2014-10-18', NULL, 3, '', ''),
	(10, 17, '2014-10-18', NULL, 20, '', ''),
	(11, 17, '2014-10-18', NULL, 30, '', ''),
	(12, 11, '2014-10-29', NULL, 30, '', ''),
	(13, 12, '2014-10-29', NULL, 2, '', ''),
	(14, 13, '2014-10-29', NULL, 33, '', ''),
	(15, 12, '2014-10-29', NULL, 30, '', '');
...
# Dumping data for table ume_school_db.tbl_teacher_payment: ~4 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_teacher_payment_record: ~5 rows (approximately)

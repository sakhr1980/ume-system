...
# Dumping data for table ume_school_db.tbl_experiences: ~10 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tbl_schadule` (
  ...
  `sch_titile` varchar(45) DEFAULT NULL,
  `sch_created` datetime DEFAULT NULL,
  `sch_modified` datetime DEFAULT NULL,
  `tbl_majors_maj_id` int(11) NOT NULL,
...
# Dumping data for table ume_school_db.tbl_schadule: ~0 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `tbl_schadule_detail` (
  ...
  `tbl_schadule_sch_id` int(11) NOT NULL,
  `tbl_staffs_sta_id` int(11) NOT NULL,
  `scd_section` int(11) DEFAULT NULL,
  `scd_day` int(11) DEFAULT NULL,
  `tbl_room_rom_id` int(11) NOT NULL,
  `tbl_subject_sub_id` int(11) NOT NULL,
  PRIMARY KEY (`scd_id`),
  ...
  CONSTRAINT `fk_tbl_schadule_detail_tbl_staffs1` FOREIGN KEY (`tbl_staffs_sta_id`) REFERENCES `tbl_staffs` (`sta_id`) ON DELETE NO ACTION ON UPDATE NO ACTION
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

# Dumping data for table ume_school_db.tbl_schadule_detail: ~0 rows (approximately)
...
# Dumping data for table ume_school_db.tbl_students: 16 rows

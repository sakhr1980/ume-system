...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 15, 2014 at 11:54 PM
...
CREATE TABLE IF NOT EXISTS `tbl_staff_job_type` (
  ...
  `job_title_en` varchar(50) NOT NULL,
  `job_title_kh` varchar(50) DEFAULT NULL,
  ...
  `job_modified` timestamp NULL DEFAULT NULL,
  `tbl_users_use_id` int(11) NOT NULL,
  PRIMARY KEY (`job_id`),
  UNIQUE KEY `job_title` (`job_title_en`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 AUTO_INCREMENT=3 ;
...
CREATE TABLE IF NOT EXISTS `tbl_staff_position` (
  ...
  `pos_title_en` varchar(50) NOT NULL,
  `pos_title_kh` varchar(50) NOT NULL,
  `pos_description` varchar(250) DEFAULT NULL,
